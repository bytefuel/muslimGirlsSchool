                        ...
                        <div class="overlay-message">
                            <div class="overlay-content p-4">
                                <div class="text-content fs-6">
                                    All of our students, from Junior Kindergarten to grade 12, are taught the complete
                                    syllabus of the
                                    Ontario curriculum as required by the Ontario Ministry of Education. Our students gain
                                    knowledge in
                                    ...
                                    religious
                                    education mainly through daily taleem, and through our formal Islamic studies curriculum
                                    which
                                    includes the study of Arabic, the Quran and various areas of Islam such as:
                                    <ul>
                                        <li>Islamic Tadhib and Akhlaq (Etiquette)</li>
                                    ...
                                    gymnasium on a
                                    regular basis.
                                    In addition to the core curriculum mentioned above, we also offer the following
                                    specialized programs
                                    and activities at our institution:
                                    <div class="program" v-for="program in programs" :key="program.name">
                                        <h2>{{ program.name }}</h2>
                                        <p v-for="(paragraph, index) in program.descriptions" :key="index">{{ paragraph }}
                                        </p>
                                    </div>
